...
<body>
    <div class="email-container">
        <div class="header">
            ...
            <p>Your {{ $booking->instrument }} Demo Session is Scheduled</p>
        </div>
        ...
        <div class="content">
            ...
            <div class="details-box">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value">{{ \Carbon\Carbon::parse($booking->scheduled_at)->format('l, F j, Y \a\t h:i A') }} ({{ $booking->duration_minutes }} Mins)</span>
                </div>
                <div class="detail-item">
                    <span class="detail-label">{{ $isTeacher ? 'Student:' : 'Instructor:' }}</span>
                    <span class="detail-value">{{ $isTeacher ? ($booking->student_name ?? 'N/A') : ($booking->teacher->user->name ?? 'N/A') }}</span>
                </div>
            </div>
