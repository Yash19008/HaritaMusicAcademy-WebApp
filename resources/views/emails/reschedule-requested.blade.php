...
<head>
    ...
    <title>Class Reschedule Requested</title>
...
<body>
    <div class="email-container">
        <div class="header">
            <h1>🗓️ Class Reschedule Requested</h1>
        </div>
        ...
        <div class="content">
            ...
            <div class="details-box">
                ...
                <div class="detail-item">
                    ...
                    <span class="detail-value">{{ \Carbon\Carbon::parse($booking->reschedule_requested_starts_at)->format('l, F j, Y') }}</span>
                </div>
                <div class="detail-item">
                    <span class="detail-label">Proposed Time:</span>
                    <span class="detail-value">{{ \Carbon\Carbon::parse($booking->reschedule_requested_starts_at)->format('h:i A') }} - {{ \Carbon\Carbon::parse($booking->reschedule_requested_ends_at)->format('h:i A') }}</span>
                </div>
            </div>
