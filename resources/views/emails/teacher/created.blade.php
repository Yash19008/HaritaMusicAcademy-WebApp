...
@section('header_subtitle', 'Your Teaching Journey Begins Here')
...
<ul style="color: #4a5568; font-size: 15px; line-height: 1.6; margin: 15px 0 15px 20px; padding: 0;">
    <li style="margin-bottom: 5px;">Manage your class schedule</li>
    <li style="margin-bottom: 5px;">Conduct Demo and Regular Classes</li>
    <li style="margin-bottom: 5px;">View student enrollments</li>
    <li style="margin-bottom: 5px;">Update your profile and availability</li>
</ul>

<div style="text-align: center; margin: 20px 0;">
    <a href="{{ $loginUrl }}" style="display: inline-block; background-color: #51040e; background: linear-gradient(135deg, #51040e 0%, #7d0a1b 100%); color: #ffffff; padding: 15px 40px; text-decoration: none; border-radius: 8px; font-weight: 600; text-align: center;">Login to Your Portal</a>
</div>
