        ...
        <div class="card-body" style="padding: 0;">
            <div style="display: flex; flex-direction: column;">
                @foreach ($notifications as $notification)
                    ...
                    @endphp
                    @if ($notificationUrl)
                        <a href="{{ $notificationUrl }}" class="notification-list-item"
                            style="display: flex; gap: 12px; padding: 12px 1.5rem; border-bottom: 1px solid var(--border-color); align-items: flex-start; background-color: {{ $notification->read_at ? 'transparent' : 'rgba(13, 148, 136, 0.04)' }}; transition: background 0.2s, box-shadow 0.2s; text-decoration: none; color: inherit;">
                        @else
                            <div
                    ...
                    <div style="font-size: 0.75rem; color: #94a3b8; text-align: right; min-width: 120px; font-weight: 500;">
