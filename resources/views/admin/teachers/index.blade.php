        ...
        <div class="card-body d-flex flex-wrap align-center justify-between gap-3">
            <div class="d-flex gap-2 flex-wrap" style="flex:1;max-width:400px;">
                <input type="text" id="searchBar" class="form-control" placeholder="Quick filter by name..."
                    style="flex:1;" oninput="if(dtTable) dtTable.search(this.value).draw()">
            </div>
                ...
                @foreach ($teachers as $teacher)
                    <tr>
                        <td class="font-bold" style="color:var(--primary)">
                            TCH{{ str_pad($teacher->id, 3, '0', STR_PAD_LEFT) }}</td>
                        <td>
                        ...
                        <td>
                            ...
                            <span
                                class="badge {{ $st === 'active' ? 'badge-success' : ($st === 'on_leave' ? 'badge-warning' : 'badge-danger') }}">
                        ...
                        <td>
                            <div class="actions-dropdown-container">
                                ...
                                <div class="actions-dropdown-menu" style="min-width:140px;">
                                    <button class="actions-dropdown-item" onclick="openEditTeacher({{ $teacher->id }})">✏️
                                        Edit</button>
                                    <form method="POST" action="{{ route('admin.teachers.destroy', $teacher) }}"
                                        onsubmit="return confirm('Delete this teacher?')" style="margin:0;">
                                        @csrf @method('DELETE')
                ...
                <div class="modal-body">
                    ...
                    <div class="grid grid-2 gap-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="tfName" class="form-control" required
                                placeholder="e.g. Meera Sharma">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Email Address *</label>
                            <input type="email" name="email" id="tfEmail" class="form-control" required
                                placeholder="e.g. meera@haritamusic.com">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-2 gap-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" id="tfPhone" class="form-control"
                                placeholder="+91 87654 32109">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Experience</label>
                            <input type="text" name="experience" id="tfExperience" class="form-control"
                    ...
                    <div class="grid grid-2 gap-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="specialization" id="tfSpecialization" class="form-control"
                    ...
                    <div class="grid grid-2 gap-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="rating" id="tfRating" class="form-control" min="0"
                                max="5" step="0.1" placeholder="e.g. 4.8">
                        </div>
                    </div>
                    ...
                    <div class="grid grid-2 gap-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="emergency_contact_name" id="tfEmgName" class="form-control"
                                placeholder="e.g. Rajesh Sharma">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Emergency Contact Phone</label>
                            <input type="text" name="emergency_contact_phone" id="tfEmgPhone" class="form-control"
                    ...
                    <div class="grid grid-2 gap-3">
                        <div class="form-group">
                            ...
                            <input type="number" name="per_class_rate" id="tfClassFee" class="form-control"
                                step="0.01" min="0" placeholder="e.g. 500">
                        </div>
                        <div class="form-group">
                            <label class="form-label">Certifications (comma-separated)</label>
                            <input type="text" name="certifications" id="tfCertifications" class="form-control"
                                placeholder="e.g. ABRSM Grade 8, RCM">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="bio" id="tfBio" class="form-control" style="height:60px;"
                            placeholder="Teaching experience and background..."></textarea>
                    </div>
