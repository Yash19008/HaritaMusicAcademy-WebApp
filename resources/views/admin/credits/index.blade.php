...
@section('content')
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-between align-center">
            ...
            <input type="text" id="creditSearch" class="form-control" placeholder="Quick filter name..."
                style="width:200px;" oninput="if(dtBalances) dtBalances.search(this.value).draw()">
        </div>
                                ...
                                <div class="actions-dropdown-container" style="display:inline-block;">
                                    ...
                                    <div class="actions-dropdown-menu" style="min-width:160px;">
                                        <button class="actions-dropdown-item"
                                            onclick="openQuickAdjust({{ $s->id }}, 'add')">🪙 Add Credits</button>
                                        <button class="actions-dropdown-item text-danger"
                                            onclick="openQuickAdjust({{ $s->id }}, 'deduct')">💸 Deduct
                                            Credits</button>
                                    </div>
                                </div>
                            </td>
    ...
    <div id="creditAdjustModal" class="modal-backdrop">
        <div class="modal" style="max-width: 480px;">
            ...
            <form method="POST" action="{{ route('admin.credits.adjust') }}" id="adjustmentForm"
                ...
                <div class="modal-body">
                    ...
                    <div class="grid grid-2 gap-3 mb-3">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="adjAmount" class="form-control" min="1" value="1"
                                required>
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary"
                        onclick="hideModal('creditAdjustModal')">Cancel</button>
