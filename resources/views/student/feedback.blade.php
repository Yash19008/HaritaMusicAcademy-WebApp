            ...
            <div class="card-body p-4">
                <form action="{{ route('student.feedback.store') }}" method="POST">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <select name="category" id="fbCategory" class="form-control" required
                            onchange="toggleCategoryTarget()">
                    ...
                    <div class="form-group mb-3">
                        ...
                        <textarea name="message" id="fbMessage" class="form-control" rows="4"
