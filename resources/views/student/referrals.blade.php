    ...
    <div class="referral-grid">
        ...
        <div>
            ...
            <div class="referral-code-card">
                <h4 class="font-semibold" style="font-family: var(--font-serif); font-size: 1.1rem; color: var(--text-main);">
                    My Referral Code</h4>
            ...
            <div class="card">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('student.referrals.store') }}" method="POST">
                        @csrf
                        <div class="form-group mb-3">
                            <label class="form-label font-semibold">Friend's Name</label>
                            <input type="text" name="referred_name" class="form-control" placeholder="Enter full name"
                                required>
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label font-semibold">Friend's Email</label>
                            <input type="email" name="referred_email" class="form-control"
                                placeholder="eg. friend@example.com" required>
                        </div>
                        <div class="form-group mb-3">
