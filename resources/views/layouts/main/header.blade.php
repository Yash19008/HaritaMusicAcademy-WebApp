    ...
    <div class="header-right">
        ...
        <div class="header-profile-dropdown">
            ...
            <a href="{{ route('notifications.index') }}" class="dropdown-item"
                style="text-align: center; color: var(--primary); font-weight: 600; padding: 10px; background: #f8f9fa; border-top: 1px solid var(--border-color); position: sticky; bottom: 0;">See
                All Notifications</a>
        </div>
    </div>
        ...
        <div id="profileDropdown" class="dropdown-menu">
            ...
            <form method="POST" action="{{ route('logout') }}" style="display: inline;">
                ...
                <button type="submit" class="dropdown-item"
                    style="color: var(--danger); width: 100%; text-align: left; background: none; border: none; padding: 0.5rem 1rem; cursor: pointer;">Log
                    Out</button>
            </form>
        </div>
    </div>
