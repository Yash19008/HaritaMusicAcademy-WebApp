...
<body>
    ...
    <style>
        ...
        .policy-modal-content {
            background: #fff; border-radius: 16px; max-width: 680px; width: 94%; max-height: 85vh; 
            display: flex; flex-direction: column; overflow: hidden; box-shadow: 0 20px 60px rgba(0,0,0,0.3);
            animation: modalFadeIn 0.3s ease-out forwards;
        }
        @keyframes modalFadeIn { from { opacity: 0; transform: translateY(20px); } to { opacity: 1; transform: translateY(0); } }
        .policy-modal-header {
            background: var(--primary); color: #fff; padding: 1.25rem 1.5rem; display: flex; justify-content: space-between; align-items: center;
        }
        .policy-modal-title { margin: 0; font-family: var(--font-serif, serif); font-size: 1.35rem; font-weight: 700; display: flex; align-items: center; gap: 0.5rem; color: #ffffff !important; }
        .policy-modal-close {
            background: rgba(255,255,255,0.15); border: none; width: 32px; height: 32px; border-radius: 50%; color: #fff; font-size: 1.2rem; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: background 0.2s;
        }
        .policy-modal-close:hover { background: rgba(255,255,255,0.3); }
        .policy-modal-body { padding: 1.5rem; overflow-y: auto; font-size: 0.95rem; line-height: 1.6; color: #4b5563; }
        .premium-policy-list { list-style: none; padding: 0; margin: 0; }
        .premium-policy-list li {
            position: relative; padding: 1rem 1rem 1rem 3rem; border-bottom: 1px solid #f3f4f6; counter-increment: policy-counter;
        }
        .premium-policy-list li:nth-child(even) { background-color: #fcfcfc; }
        .premium-policy-list li:last-child { border-bottom: none; }
        .premium-policy-list li::before {
            content: counter(policy-counter); position: absolute; left: 0.75rem; top: 1rem; width: 24px; height: 24px; background: rgba(81, 4, 14, 0.1); color: var(--primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; font-size: 0.75rem; font-weight: bold;
        }
        .premium-policy-list strong { color: var(--primary); font-weight: 600; }
        .policy-modal-footer {
            padding: 1.25rem 1.5rem; border-top: 1px solid #e5e7eb; background: #f9fafb; text-align: center;
        }
    </style>
    ...
    <div id="privacy-modal" class="modal-overlay">
        <div class="policy-modal-content">
            ...
            <div class="policy-modal-footer">
                <button onclick="closePrivacyModal()" class="btn btn-primary" style="padding: 0.6rem 2rem; border-radius: 8px;">I Understand & Agree</button>
            </div>
        </div>
    </div>
